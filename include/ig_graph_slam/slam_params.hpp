...
struct Params {
  ...
  std::string bag_file_path, lidar_topic_loc, lidar_topic_map, gps_topic,
      ...
      extrinsics_filename, odom_frame, pose_output_override, init_files_path;
  ...
  float trajectory_sampling_dist, map_sampling_dist, trajectory_rotation_change,
      ...
      downsample_cell_size, set_search_radius, x_lower_threshold,
      x_upper_threshold, y_lower_threshold, y_upper_threshold,
      z_lower_threshold, z_upper_threshold, x_lower_threshold_map,
      x_upper_threshold_map, y_lower_threshold_map, y_upper_threshold_map,
      z_lower_threshold_map, z_upper_threshold_map, loop_max_distance,
      loop_min_travel_distance;
