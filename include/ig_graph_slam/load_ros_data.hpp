...
struct ROSBag
{
  ...
  /***
   ...
   Eigen::Affine3d getGPSTransform(const TimePoint &time_point, bool applyT_ENU_GPS);
    ...
    /***
       ...
       * @param imu_topic
       */
    void loadIMUMessage(rosbag::View::iterator &rosbag_iter, bool end_of_bag, bool start_of_bag, std::string imu_topic);
     ...
     * @param p_
     */
    void loadROSBagMessage(rosbag::View::iterator &rosbag_iter, bool end_of_bag, boost::shared_ptr<Params> p_);

    /***
     * Load PCL point cloud message from ROS message into container (for localization)
     * @param lidar_msg
     * @param p_
     */
    void loadPCLPointCloudFromPointCloud2(boost::shared_ptr<sensor_msgs::PointCloud2> lidar_msg, boost::shared_ptr<Params> p_);
     ...
     * @param p_
     */
    void loadPCLPointCloudFromPointCloud2Map(boost::shared_ptr<sensor_msgs::PointCloud2> lidar_msg, boost::shared_ptr<Params> p_);
  ...
  // declare filter objects
    pcl::PCLPointCloud2::Ptr pcl_pc2_tmp; // used an intermediate when converting from ROS messages
